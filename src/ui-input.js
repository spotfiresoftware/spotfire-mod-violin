...
export const addHandlersSelection = (callback) => {
    ...
    document.onmousedown = (e) => {
        ...
        selectionPoint = { x: x, y: y + (window.scrollY || document.documentElement.scrollTop) };
        Log.green(LOG_CATEGORIES.Marking)("ui marking y start", selectionPoint, selectionPoint.y);
        meta = { ctrlKey, altKey };
    ...
    const mousemove = (e) => {
        ...
        const height = Math.abs(selectionPoint.y - (window.scrollY || document.documentElement.scrollTop) - y);
        ...
        if (y < selectionPoint.y - (window.scrollY || document.documentElement.scrollTop))
            selectionDiv.style.top = y + (window.scrollY || document.documentElement.scrollTop) + "px";
    };
